...
describe('Testing Articles Controller', function () {
  ...
  it('Should have a find method that uses $resources to retrieve a list of articles', inject(function (Articles) {
  ...
  it('Should have a findOne method that uses $resources to retrieve a single of article', inject(function (Articles) {
